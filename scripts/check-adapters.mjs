...
const expected = {
  ...
  grok: {
    ...
    urls: {
      ...
      match: ['grok.com/*'],
      ssoMatch: ['x.com/*', 'twitter.com/*', 'accounts.x.ai/*', 'challenges.cloudflare.com/*', 'accounts.google.com.tw/*', 'auth.grokipedia.com/*', 'gsi.google.com/*', 'https://www.google.com/accounts'],
    },
    inputStrategy: 'prosemirror-paste',
    doneDelayMs: 8000,
    chunkDebounceMs: 600,
